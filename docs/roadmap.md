...
- [ ] **M1 — data serializer**: tables/strings/numbers with shared-ref map, cycles, metatables, perms-at-every-node; format header (magic, version, build fingerprint) + checksums; property tests
